                ...
                <div class="mobile-menu">
                    ...
                    <div class="mobile-menu-top">
                        ...
                        <ul class="mobile-menu__icons--right">
                            ...
                            <li><a class="mobile-menu--icons" href="[[%hobbydom_instagram? &topic=`hobbydom` &namespace=`hobbydom` ]]"><img src="images/insta_footer.svg" alt=""><span>instagram</span></a></li>
                            <li><a class="mobile-menu--icons" href="[[%hobbydom_facebook? &topic=`hobbydom` &namespace=`hobbydom` ]]"><img src="images/fb_footer.svg" alt=""><span>facebook</span></a></li>
                        </ul>
                    </div>
