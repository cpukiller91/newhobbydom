                ...
                <div class="nav__top">
                    <div class="nav__top--wrapper">
                        <div class="nav__top--left">
                            ...
                            <img src="images/mail.svg" alt=""><a href="mailto:[[%hobbydom_header_mail? &topic=`hobbydom` &namespace=`hobbydom` ]]">[[%hobbydom_header_mail? &topic=`hobbydom` &namespace=`hobbydom` ]]</a>
                        </div>
                        <div class="nav__top--right">
                            <a target="_blank" href="[[%hobbydom_instagram? &topic=`hobbydom` &namespace=`hobbydom` ]]"><img class="nav__top--instagram" src="images/insta_heder.svg" alt=""></a>
                            <a target="_blank" href="[[%hobbydom_facebook? &topic=`hobbydom` &namespace=`hobbydom` ]]"><img class="nav__top--facebook" src="images/fb_heder.svg" alt=""></a>
                            <!--                                <a href="contacts.html">КОНТАКТЫ</a>-->
                            <div class="nav__top--languages" href="ru">[[++cultureKey]]
                    ...
                    <div class="mobile-menu-top">
                        <ul>
                            [[pdoMenu?
                                ...
                                &tpl=`@INLINE <li><a href="/[[++cultureKey]]/[[+link]]">[[+pagetitle]]</a></li>`
                            ]]
                            <li><a target="_blank" href="[[%hobbydom_facebook? &topic=`hobbydom` &namespace=`hobbydom` ]]" class="mobile-menu--icons"><img src="images/fb_footer.svg" alt=""><span>facebook</span></a></li>

                        </ul>
                        <ul class="mobile-menu__icons--right">
                            <li><a href="[[~9]]">Юрмала</a</li>
                            <li>
                                <a class="mobile-menu-mail" href="mailto:[[%hobbydom_header_mail? &topic=`hobbydom` &namespace=`hobbydom` ]]">[[%hobbydom_header_mail? &topic=`hobbydom` &namespace=`hobbydom` ]]</a>
                            </li>
                            <li><a href="tel:[[%hobbydom_header_phone1? &topic=`hobbydom` &namespace=`hobbydom` ]]">[[%hobbydom_header_phone1? &topic=`hobbydom` &namespace=`hobbydom` ]]</a></li>
                            <li><a href="tel:[[%hobbydom_header_phone2? &topic=`hobbydom` &namespace=`hobbydom` ]]">[[%hobbydom_header_phone2? &topic=`hobbydom` &namespace=`hobbydom` ]]</a></li>
                            ...
                            <li><a target="_blank" class="mobile-menu--icons" href="[[%hobbydom_instagram? &topic=`hobbydom` &namespace=`hobbydom` ]]"><img src="images/insta_footer.svg" alt=""><span>instagram</span></a></li>
                        </ul>
                    </div>
            ...
            <div class="nav__slider">
                <div class="swiper-container swiper-container-top">
                    <div class="swiper-wrapper">
                        [[BannerY?
                        	&positions=`[[%hobbydom_swiper_slide_positions? &topic=`hobbydom` &namespace=`hobbydom` ]]`
                        	&tpl=`Bannery.outer`
                        ]]
