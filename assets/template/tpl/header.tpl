                ...
                <div class="nav__top">
                    <div class="nav__top--wrapper">
                        ...
                        <div class="nav__top--right">
                            ...
                            <div class="nav__top--languages">[[++cultureKey]]
                                ...
                                <div class="languages-content">
                                    ...
                                    <a [[++cultureKey:is=`ru`:then=`style="color: #36baa2;"`]] href="/ru/[[~[[*id]]]]">RU</a>
                                    <a [[++cultureKey:is=`lv`:then=`style="color: #36baa2;"`]] href="/lv/[[~[[*id]]]]">LV</a>
                                </div>
                            </div>
