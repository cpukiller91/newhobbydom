...
$_lang['hobbydom_svg_alt'] = 'Ограничение вывода Предметов на странице.';
...
$_lang['hobbydom_b_cookies__content'] = '<p>Продолжая использовать сайт, Вы даёте своё согласие на работу с файлами cookie и соглашаетесь с <a target="_blank" href="/publichnyj-dogovor-oferty.html">политикой конфиденциальности.</a>';
   /* '
...
$_lang['hobbydom_swiper_slide_button'] = 'Подробнее';
...
<div class="b__girl--content-left">
    <p><span class="b__girl--content-bold">делай</span><br><span class="b__girl--content-light">то, что любишь</span></p>
</div>
